...
repetitive_data = ""
...
def run_length_encoding(binary_string):
    alpha_string = convert_to_alpha(binary_string)
    encoded_string = ""
    zeros = 0
    ones = 0
    for c in alpha_string:
        if c == "o":
            ...
            if ones != 0:
                ...
                encoded_string += str(ones)
                ones = 0
        elif c == "i":
            ones += 1
            if zeros != 0:
                encoded_string += str("o")
                encoded_string += str(zeros)
                zeros = 0
    if ones != 0:
                encoded_string += str("i")
                encoded_string += str(ones)
...
# This will compress strings of 1s and 0s, and simply give alternating numbers listing the sequence length starting with the number of zeroes at the start.
def run_length_encoding_superior(binary_string):
    encoded_string = ""
    count = 0
    last_char = "0"
...
run_length_encoding(repetitive_data)
run_length_encoding_superior(repetitive_data)
